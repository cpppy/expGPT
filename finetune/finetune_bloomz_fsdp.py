...
class CFG:
    ...
    # dataset
    tokenizer_path = '/data/data/llama_tokenizer/tokenizer.model'
    train_datas = [
        dict(
    ...
    # resume = None
    resume = '/data/output/expGPT_pretrain_gpt2Dataset_experiment1/iter-00059999-ckpt.pth'
...
def train(gpu, args):
    ...
    # train_sampler = torch.utils.data.distributed.DistributedSampler(combined_dataset,
    #                                                                 shuffle=True,
    #                                                                 rank=rank)
    ...
    from finetune.function_call_llama3_dataset import FunctionCallingDataset
