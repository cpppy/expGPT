...
def build_dataset(tokenizer, max_len=256, eval_ratio=0.1):
    ...
    train_dataset = CustomQADataset(samples[:split_pos], tokenizer=tokenizer, max_len=max_len)
    ...
    eval_dataset = CustomQADataset(samples[split_pos:], tokenizer=tokenizer, max_len=max_len)
