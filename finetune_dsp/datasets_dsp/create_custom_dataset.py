...
'''
dschat/utils/data/data_utils.py
...
# from finetune_dsp.datasets_dsp.raw_dataset import PromptRawDataset
#
# # Chinese dataset
# class Wangrui6ZhihuKOLDatasetLocal(PromptRawDataset):
#
#     def __init__(self, output_path, seed, local_rank, dataset_name):
#         logger.debug(f'dataset_name: {dataset_name}, output_path: {output_path}')
#         # exit(0)
...
from finetune_dsp.datasets_dsp.raw_dataset import Wangrui6ZhihuKOLDatasetLocal
...
def get_raw_dataset(dataset_name, output_path, seed, local_rank):
    ...
    elif os.path.exists(dataset_name) and "Zhihu-KOL" in dataset_name:
        return Wangrui6ZhihuKOLDatasetLocal(output_path,
                                            seed,
                                            local_rank,
                                            dataset_name)
