...
def train():
    ...
    training_args = TrainingArguments(
        ...
        output_dir="output_llama410m_scratch",
        log_level='debug',
        # deepspeed={
        #     "zero_optimization": {
        #         # "stage": 1,
    ...
    #     # trust_remote_code=True,
    # )
    # config = Qwen2Config.from_json_file('/data/data/Qwen2-0.5B-Instruct/config.json')
    ...
    # from finetune_qwen.llama410m_model import MyConfig, Llama410mModel
    # config = MyConfig(4)
