...
def train():
    ...
    model = Qwen2ForCausalLM.from_pretrained(
        '/data/expGPT/finetune_qwen/output_qwen2_scratch/checkpoint-10000',
...
# for 4090*2
NCCL_P2P_DISABLE="1" NCCL_IB_DISABLE="1" python3.11 -m torch.distributed.run --nproc_per_node 2 --nnodes 1 --node_rank 0 --master_addr localhost --master_port 6601 train_qwen2_from_scratch_pretrain.py
