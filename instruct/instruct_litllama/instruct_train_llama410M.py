...
class CFG:
    ...
    ckpt_dir = '/data/output/expGPT_instruct_alpaca_experiment2'
    save_interval = 5000
    eval_interval = 1000
    eval_iters = 100
    log_interval = 20
...
def train(gpu, args):
    ...
    from instruct.instruct_litllama.load_alpaca_litllama_v2 import AlpacaDataset
    ...
    for epoch_id in range(iter_num // n_batch, cfg.max_iters // n_batch + 1):
