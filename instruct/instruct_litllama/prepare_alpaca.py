...
def prepare(
    ...
    tokenizer_path: Path = Path("/data/llm_models/llama_tokenizer/tokenizer.model"),
    ...
    file_path = Path('/data/lit-llama/recon/data/alpaca/alpaca_data_cleaned_archive.json')
