...
def train():
    ...
    dataset = build_dataset(
        data_dir='/data/data/llm_data/pretrain_webtext',
        prefix='webtext.train',
        # data_dir='/data/data/llm_data/pretrain_medium-345M',
        # prefix='medium-345M.train',
    ...
    from utils.checkpoint_mgr import CheckpointMgr
    ...
    for i in range(10000):
        for iter_num, train_data in enumerate(train_dataloader):
            ...
            if iter_num >= len(train_dataloader) - 1:
                break
