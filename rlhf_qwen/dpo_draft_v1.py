...
def main():
    ...
    from rlhf_qwen.load_dpo_data import build_dpo_dataset
    ...
    trainer = DPOTrainer(
        ...
        eval_dataset=None,
        tokenizer=tokenizer,
        peft_config=None, #peft_config if args.use_peft else None,
        max_prompt_length=512, #args.max_source_length,
        max_length=1024, #full_max_length,
        # model_init_kwargs={},
    )
    ...
    if True: #args.do_train:
        ...
        metrics["train_samples"] = 500 #max_train_samples
